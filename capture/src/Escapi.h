...
ESCAPI int getCapturePropertyAuto(unsigned int deviceno, int prop);
...
*/
ESCAPI int initCaptureWithOptions(unsigned int deviceno, struct SimpleCapParams *aParams, unsigned int aOptions);
